...
abstract class core_completion_edit_base_form extends moodleform {
    ...
    protected function add_completion_rules() {
        list($this->hascustomrules, $customcompletionelements) = $this->add_custom_completion('add_completion_rules');
    ...
    public function add_completiongrade_rules(): array {
        list($this->hascustomrules, $customcompletionelements) = $this->add_custom_completion('add_completiongrade_rules');
        return $customcompletionelements;
    }
