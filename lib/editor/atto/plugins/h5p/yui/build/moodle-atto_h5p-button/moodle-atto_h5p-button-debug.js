            ...
            '<form class="atto_form mform" id="{{elementid}}_atto_h5p_form">' +
                ...
                '<div class="mb-4">' +
                    ...
                    '<div class="input-group input-append w-100">' +
                        ...
                        '</span>' +
                    '</div>' +
                    '<fieldset class="collapsible collapsed" id="{{elementid}}_h5poptions">' +
...
Y.namespace('M.atto_h5p').Button = Y.Base.create('button', Y.M.editor_atto.EditorPlugin, [], {
    ...
    _getH5PIframe: function() {
        var selectednode = Y.one(this.get('host').getSelectionParentNode());
    ...
    _setH5P: function(e) {
        ...
        if (this._placeholderH5P && this._placeholderH5P.get('parentNode')) {
            this._placeholderH5P.get('parentNode').remove();
        }
