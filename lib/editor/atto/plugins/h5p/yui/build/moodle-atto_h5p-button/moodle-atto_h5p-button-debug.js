    ...
    _getDialogueContent: function() {
        ...
        if (this._H5PDiv) {
            ...
            if (fileBaseUrl == H5PURL.substring(0, fileBaseUrl.length)) {
                ...
                if (parameters) {
                    var reDownloadButton = /export=1/;
                    if (parameters.match(reDownloadButton)) {
                        optionDownloadButton = 'checked';
                        collapseOptions = false;
                    }

                    var reEmbedButton = /embed=1/;
                    if (parameters.match(reEmbedButton)) {
                        optionEmbedButton = 'checked';
                        collapseOptions = false;
                    }

                    var reCopyrightButton = /copyright=1/;
                    if (parameters.match(reCopyrightButton)) {
