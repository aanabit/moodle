...
Feature: Add h5ps to Atto
  ...
  Scenario: Edit H5P content
    Given I log in as "teacher1"
    And I follow "Manage private files..."
    And I upload "lib/editor/atto/tests/fixtures/course-presentation.h5p" file to "Files" filemanager
    And I click on "Save changes" "button"
    And I am on "Course 1" course homepage
    And I follow "PageName1"
    And I navigate to "Edit settings" in current page administration
...
#   H5P file content
    And I click on "Browse repositories..." "button" in the "Insert H5P" "dialogue"
    And I click on "Private files" "link" in the ".fp-repo-area" "css_element"
    And I click on "course-presentation.h5p" "link"
    And I click on "Select this file" "button"
    And I click on "Insert H5P" "button" in the "Insert H5P" "dialogue"
    And I wait until the page is ready
    When I click on "Save and display" "button"
    ...
    Then I should not see "Lorum ipsum"
    And I should see "Cloudberries"
    And I switch to the main frame
    And I navigate to "Edit settings" in current page administration
    And I click on ".h5p-file-placeholder" "css_element"
    And I click on "Insert H5P" "button" in the "#fitem_id_page" "css_element"
#   External URL
    And I set the field with xpath "//textarea[@data-region='h5purl']" to "https://h5p.org/h5p/embed/576651"
    And I click on "Insert H5P" "button" in the "Insert H5P" "dialogue"
