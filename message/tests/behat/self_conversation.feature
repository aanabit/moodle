...
Feature: Self conversation
  ...
  Scenario: Self conversation can be unstarred
    ...
    And I should not see "Student 1" in the "//div[@data-region='view-overview-favourites']" "xpath_element"
    And I open the "Private" conversations list
    And I should see "Student 1" in the "//div[@data-region='view-overview-messages']" "xpath_element"
  ...
  Scenario: Self conversation can be deleted
    ...
    And I should not see "Student 1" in the "//div[@data-region='view-overview-favourites']" "xpath_element"
    And I open the "Private" conversations list
    And I should not see "Student 1" in the "//div[@data-region='view-overview-messages']" "xpath_element"
