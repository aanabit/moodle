...
Feature: Manage notification preferences - Email
  ...
  Scenario: Disable email notifications for everybody
    ...
    When I navigate to "Plugins > Message outputs > Manage message outputs" in site administration
    And "Output disabled" "icon" should exist in the "Email" "table_row"
    And I log out
  ...
  Scenario: Enable email notifications
    ...
    Given I log in as "admin"
    When I navigate to "Plugins > Message outputs > Manage message outputs" in site administration
    And I click on "Output disabled" "icon" in the "Email" "table_row"
    And I log out
    And I log in as "student1"
    And I open messaging
    And I open messaging settings preferences
  ...
  Scenario: Config jabber
    ...
    And "Output enabled" "icon" should exist in the "Jabber" "table_row"
    And I log out
    And I log in as "student1"
    And I open messaging
    And I open messaging settings preferences
    ...
    And I click on "Save changes" "button" in the ".moodle-dialogue-bd" "css_element"
