...
Feature: Manage notification preferences - Email
  ...
  Scenario: Disable email notifications for everybody
    ...
    When I navigate to "Site administration > Messaging > Notification settings" in site administration
    And I set the field with xpath "//input[@id='email']" to "0"
  ...
  Scenario: Enable email notifications
    Given I log in as "admin"
    When I navigate to "Site administration > Messaging > Notification settings" in site administration
    And I set the field with xpath "//input[@id='email']" to "1"
    And I press "Save changes"
    And I log out
    And I log in as "student1"
    And I open messaging
  ...
  Scenario: Disable email notifications
    Given the following "user preferences" exist:
      ...
      | student1  | message_provider_moodle_instantmessage_loggedin   | email |
  ...
  Scenario: Config jabber
    ...
    And I navigate to "Site administration > Messaging > Notification settings" in site administration
    And I set the field with xpath "//input[@id='jabber']" to "1"
    And I press "Save changes"
    ...
    And I set the field with xpath "//input[@name='jabber_jabberid']" to "student1@jabber.org"
