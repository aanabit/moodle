...
class core_message_api_testcase extends core_message_messagelib_testcase {
   ...
   public function get_conversations_mixed_provider() {
    ...
    /**
     * Tests the user can post a message to a 1:1 conversation.
     */
    public function test_can_post_conversation_message() {
        // Create some users.
        $user1 = self::getDataGenerator()->create_user();
        $user2 = self::getDataGenerator()->create_user();
        ...
        // With the default privacy setting, users can't message them.
        $this->assertFalse(\core_message\api::can_post_conversation_message($user2->id, $user1->id));
        ...
        $this->getDataGenerator()->enrol_user($user2->id, $course->id);
        // After enrolling users to the course, they should be able to message them with the default privacy setting.
        $this->assertTrue(\core_message\api::can_post_conversation_message($user2->id, $user1->id));
    }

    /**
     * Tests the user can't post a message without proper capability.
     */
    public function test_can_post_conversation_message_without_sendmessage_cap() {
        global $DB;
     ...
     */
    public function test_can_post_conversation_message_when_contact() {
        // Create some users.
        $user1 = self::getDataGenerator()->create_user();
        $user2 = self::getDataGenerator()->create_user();
     ...
     */
    public function test_can_post_conversation_message_when_not_contact() {
        // Create some users.
        $user1 = self::getDataGenerator()->create_user();
        $user2 = self::getDataGenerator()->create_user();
     ...
     */
    public function test_can_post_conversation_message_when_blocked() {
        // Create some users.
        $user1 = self::getDataGenerator()->create_user();
        $user2 = self::getDataGenerator()->create_user();
        ...
        $this->assertFalse(\core_message\api::can_post_conversation_message($user1->id, $user2->id));
    }
     ...
     */
    public function test_can_post_conversation_message_site_messaging_setting() {
        // Create some users.
        $user1 = self::getDataGenerator()->create_user();
        $user2 = self::getDataGenerator()->create_user();
     ...
     */
    public function test_can_post_conversation_message_with_messageanyuser_cap() {
        global $DB;
        ...
        $this->assertTrue(\core_message\api::can_post_conversation_message($student1->id, $teacher1->id));
        // Check that the teacher can't contact user1 because it's not his teacher.
        $this->assertFalse(\core_message\api::can_post_conversation_message($user1->id, $teacher1->id));
        ...
        $this->assertFalse(\core_message\api::can_post_conversation_message($student1->id, $teacher1->id));
        // However, teacher can message student2 because they are sharing a course.
        $this->assertTrue(\core_message\api::can_post_conversation_message($student2->id, $teacher1->id));
    }
