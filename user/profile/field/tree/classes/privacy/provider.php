...
namespace profilefield_tree\privacy;
...
class provider implements
    ...
    public static function get_metadata(collection $collection) : collection {
        return $collection->add_database_table('user_info_data', [
            'userid' => 'privacy:metadata:profilefield_tree:userid',
            'fieldid' => 'privacy:metadata:profilefield_tree:fieldid',
            'data' => 'privacy:metadata:profilefield_tree:data',
            'dataformat' => 'privacy:metadata:profilefield_tree:dataformat'
        ], 'privacy:metadata:profilefield_tree:tableexplanation');
    }
            ...
            if ($context->contextlevel == CONTEXT_USER && $context->instanceid == $user->id) {
                ...
                foreach ($results as $result) {
                    ...
                    \core_privacy\local\request\writer::with_context($context)->export_data([
                        get_string('pluginname', 'profilefield_tree')], $data);
                }
            }
        }
    }
