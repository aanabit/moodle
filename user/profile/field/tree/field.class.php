...
/**
 * Tree hierarchical profile field.
 *
...
/**
 * Class profile_field_tree
 *
 * @copyright  2021 Amaia Anabitarte <amaia@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class profile_field_tree extends profile_field_base {
     ...
     * Constructor method.
     *
     * Pulls out the options for the dropdown from the database and sets the corresponding key for the data if it exists.
     *
     * @param int $fieldid
     * @param int $userid
    ...
    public function edit_field_add($mform) {
        if ($this->field->param1 == 0) {
            ...
            // Button to update value specific options.
            $mform->registerNoSubmitButton('updatevalue');
            $mform->addElement('submit', 'updatevalue', get_string('updatevalue', 'profilefield_tree'));
     ...
     *
     * @param string $value one of the values in the options.
     * @return int options key for the options
     */
