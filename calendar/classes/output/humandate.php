...
class humandate implements renderable, templatable {
    ...
    public function __construct(
        ...
        /** @var \moodle_url|null $link Link for the date. */
    ...
    public function export_for_template(\renderer_base $output): array {
        ...
        if (($this->near !== null) && ($due < $this->near && $due > 0)) {
            $icon = new pix_icon('i/warning', get_string('warning'), 'moodle', ['class' => 'me-0 pb-1']);
            $data['isnear'] = $icon->export_for_template($output);
        }
        return $data;
    }
