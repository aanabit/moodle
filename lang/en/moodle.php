...
$string['courseindentation'] = 'Allow indentation on course page';
$string['courseindentation_help'] = 'Allow teachers, and other users with the manage activities capability, to indent items on the course page.';
