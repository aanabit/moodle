...
$string['contentbank:manageanycontent'] = 'Manage any content in the content bank on the site (rename, move, publish, share, etc.)';
$string['contentbank:manageowncontent'] = 'Manage content in the content bank created by the user (rename, move, publish, share, etc.)';
