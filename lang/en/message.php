...
$string['addcontactconfirm'] = 'Are you sure you want to add {$a} to contacts?';
...
$string['notincontactsheading'] = '{$a} is not in contacts';
$string['notincontacts'] = 'You need to add {$a} to contacts to be able to send them messages.';
...
$string['removecontactconfirm'] = 'Are you sure you want to remove {$a} from contacts?';
