...
$PAGE->set_url('/mod/subsection/index.php', array('id' => $id));
...
if (empty($subsections)) {
    notice(get_string('no$subsectioninstances', 'mod_subsection'), new moodle_url('/course/view.php', array('id' => $course->id)));
}
...
foreach ($subsections as $subsection) {
    if (!$subsection->visible) {
        $link = html_writer::link(
            new moodle_url('/mod/subsection/view.php', array('id' => $subsection->coursemodule)),
    ...
    if ($course->format == 'weeks' || $course->format == 'topics') {
        $table->data[] = array($subsection->section, $link);
    } else {
