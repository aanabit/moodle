...
final class sectiondelegate_test extends \advanced_testcase {
    ...
    public function test_get_section_action_menu(): void {
        ...
        // The possible options are: View, Edit, Hide, Show, Move and Permalink.
        ...
        // This is a unit test that hasn't set $PAGE->url, so delegatedcontrolmenu class
        // triggers a debugging message when trying to decide whether the menu is the section page
        // header, or link to content.
        $this->assertDebuggingCalled('This page did not call $PAGE->set_url(...). Using ');
