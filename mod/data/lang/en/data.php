...
$string['deleteconfirm'] = 'Delete preset {$a->name}?';
...
$string['errorpresetexistsbutnotoverwrite'] = 'A preset with this name already exists. Choose a different name because you don\'t have the right permissions to overwrite it. ';
...
$string['presetnotdeleted'] = 'An error was encountered while trying to delete the preset.';
