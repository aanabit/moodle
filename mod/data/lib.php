 ...
 * @deprecated since Moodle 4.1 MDL-75187 - please, use the preset::can_delete() function instead.
 * @todo MDL-75189 This will be deleted in Moodle 4.5.
 * @see preset::can_delete()
 */
function data_user_can_delete_preset($context, $preset) {
    global $USER;

    debugging('data_user_can_delete_preset() is deprecated. Please use manager::can_delete() instead.', DEBUG_DEVELOPER);
