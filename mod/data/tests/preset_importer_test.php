...
use file_archive;
use mod_data\importer\preset_existing_importer;
use mod_data\importer\preset_upload_importer;
use stdClass;
use zip_archive;
 ...
 * @coversDefaultClass \mod_data\importer\preset_importer
 */
class preset_importer_test extends \advanced_testcase {
    ...
    public function test_needs_mapping() {
        ...
        $fixture = $CFG->dirroot . '/mod/data/tests/fixtures/image_gallery_preset.zip';
        $uploadedimporter = new preset_upload_importer($manager, $fixture);
