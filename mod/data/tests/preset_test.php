...
class preset_test extends \advanced_testcase {
    ...
    public function test_create_from_plugin() {
        ...
        $plugindir = "path/to/plugin/$pluginname";
        $result = preset::create_from_plugin(null, $pluginname, $plugindir);
        ...
        $this->assertEmpty($result->userid);
        $this->assertEmpty($result->storedfile);
        $this->assertEquals($plugindir, $result->path);
        ...
        $result = preset::create_from_plugin(null, $pluginname, $plugindir);
        $this->assertTrue($result->isplugin);
        $this->assertEquals(preset::get_name_from_plugin($pluginname), $result->name);
        $this->assertEquals($pluginname, $result->shortname);
        $this->assertEquals(preset::get_description_from_plugin($pluginname), $result->description);
        $this->assertEmpty($result->userid);
        $this->assertEmpty($result->storedfile);
        $this->assertEquals($plugindir, $result->path);
    }
    ...
    public function test_create_from_storedfile() {
        ...
        $this->assertEquals($savedpreset->storedfile->get_userid(), $result->userid);
        $this->assertNotEmpty($result->storedfile);
        $this->assertEquals('/' . $record->name . '/', $result->path);
    ...
    public function test_create_from_instance() {
        ...
        $this->assertEmpty($result->storedfile);
        $this->assertEquals('/' . $presetname . '/', $result->path);
    }
    ...
    public function test_generate_preset_xml(array $params, ?string $description) {
        ...
        // Make accessible the method and call it.
