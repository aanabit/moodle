...
class downloader_test extends \advanced_testcase {
     ...
     * @param array|null $filterusers the filered users (null for all users)
     ...
     * @param array $expected the escpeted file list
     */
    ...
    /**
     * Internal helper to cleanr a filename text.
     *
