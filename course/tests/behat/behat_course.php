...
class behat_course extends behat_base {
    ...
    public function i_open_section_edit_menu($section) {
        ...
        $exception = new ExpectationException('Section "' . $section . '" was not found aa', $this->getSession());
    ...
    public function i_show_section($section) {
        ...
        // Click on hide link.
        $this->execute('behat_general::i_click_on_in_the',
                array($strshow, "link", $this->escape($xpath), "xpath_element")
        );
     ...
     *
     * @Given /^I edit the section "(?P<section>(?:[^"]|\\")*)"$/
