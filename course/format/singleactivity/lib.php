...
class format_singleactivity extends core_courseformat\base {
    ...
    public function get_view_url($section, $options = array()) {
        ...
        return $this->get_format_view_url(null, $this->map_get_format_view_url_options($options));
    }
        ...
        if (has_capability('moodle/course:viewhiddensections', $context)) {
            ...
            if (!empty($modinfo->sections[1])) {
                ...
                $orphanednode = $node->add(get_string('orphaned', 'format_singleactivity'),
                        $this->get_format_view_url($section1), navigation_node::TYPE_SECTION, null, $section1->id);
