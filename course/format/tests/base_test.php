...
class base_test extends advanced_testcase {
    ...
    public function test_get_format_view_url(): void {
        ...
        $this->assertStringContainsString(
            'course/section.php',
            $format->get_format_view_url($sectioninfo0, ['navigatetosection' => 1])
        );
        $this->assertStringContainsString(
            'course/section.php',
            $format->get_format_view_url($sectioninfo1, ['navigatetosection' => 1])
        );
        // When sr parameter is defined, the section.php page should be returned.
        $this->assertStringContainsString(
            'course/section.php',
            $format->get_format_view_url($sectioninfo0, ['sectiontoreturnto' => 1])
        );
        $this->assertStringContainsString(
            'course/section.php',
            $format->get_format_view_url($sectioninfo1, ['sectiontoreturnto' => 1])
        );
        $this->assertStringContainsString(
            'course/section.php',
            $format->get_format_view_url($sectioninfo0, ['sectiontoreturnto' => 0])
        );
        $this->assertStringContainsString(
            'course/section.php',
            $format->get_format_view_url($sectioninfo1, ['sectiontoreturnto' => 0])
        );
