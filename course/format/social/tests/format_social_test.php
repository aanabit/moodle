...
class format_social_test extends \advanced_testcase {
    ...
    public function test_get_view_url(): void {
        ...
        $this->assertStringContainsString('course/view.php', $format->get_view_url($section0, ['navigation' => 1]));
        $this->assertStringContainsString('course/view.php', $format->get_view_url($section1, ['navigation' => 1]));
        $this->assertStringContainsString('course/view.php', $format->get_view_url($section0, ['sr' => 1]));
        $this->assertStringContainsString('course/view.php', $format->get_view_url($section1, ['sr' => 1]));
        $this->assertStringContainsString('course/view.php', $format->get_view_url($section0, ['sr' => 0]));
        $this->assertStringContainsString('course/view.php', $format->get_view_url($section1, ['sr' => 0]));
    }
