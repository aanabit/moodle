...
class filter_h5p_testcase extends advanced_testcase {
    ...
    public function texts_provider() {
        ...
        return [
            ...
            [$CFG->wwwroot."/lib/tests/fixtures/arithmetic-quiz.h5p?forcedownload=1",
            ...
            [$CFG->wwwroot."/pluginfile.php/5/user/private/accordion-6-7138 (1).h5p",
                    "#<iframe src=\"$CFG->wwwroot/h5p/embed.php\?url=".$CFG->wwwroot."/pluginfile.php/5/user/private/accordion-6-7138\+%281%29.h5p\"[^>]*?></iframe>#"]
        ];
    }
}