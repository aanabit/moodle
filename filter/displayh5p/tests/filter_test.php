...
class filter_displayh5p_testcase extends advanced_testcase {
    ...
    public function texts_provider() {
        ...
        return [
            ...
            [$CFG->wwwroot."/lib/tests/fixtures/arithmetic-quiz.h5p?export=1&embed=1",
                "#<iframe src=\"".$CFG->wwwroot."/h5p/embed.php\?url=".rawurlencode($CFG->wwwroot."/lib/tests/fixtures/arithmetic-quiz.h5p")."&export=1&embed=1\"[^>]*?></iframe>#"],
            [$CFG->wwwroot."/pluginfile.php/5/user/private/accordion-6-7138%20%281%29.h5p.h5p",
                    "#<iframe src=\"$CFG->wwwroot/h5p/embed.php\?url=".rawurlencode($CFG->wwwroot."/pluginfile.php/5/user/private/accordion-6-7138%20%281%29.h5p.h5p")."\"[^>]*?></iframe>#"]
        ];
    }
}