...
class core_contentbank_testcase extends advanced_testcase {
    ...
    /**
     * Test create_content_from_a_file function.
     *
     * @covers ::create_content_from_a_file
     */
    public function test_create_content_from_a_file() {
        global $USER;
        ...
        $cb = new \core_contentbank\contentbank();
        $content = $cb->create_content_from_a_file($systemcontext, $USER->id, $dummyh5pfile);
