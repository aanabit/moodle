...
//     * @param   string  $expected   The supporter contenttype of the file
//     */
//    public function test_create_content(array $supporters, string $extension, string $expected) {
//        $this->resetAfterTest();
//        $mock = $this->mock_supported_extensions($supporters);
//        $cb = new \core_contentbank\contentbank();
//
...
//        // Create content.
//        $record = new stdClass();
//        $record->contenttype = 'contenttype_'.$supporter;
//        $content = $cb::create_content($record);
//
//        $expectedclass = '\\contenttype_'.$expected.'\\contenttype';
//
//        $this->assertNotEmpty($content->get_id());
