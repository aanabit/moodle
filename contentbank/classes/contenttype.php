...
abstract class contenttype {
     ...
     */
    public static final function create_content(stdClass $content = null): ?contenttype {
        global $USER, $DB;
        $record = new stdClass();
     ...
     */
    public final function can_access(): bool {
        $capability = 'contenttype/{$this->get_content_type()}:access';
