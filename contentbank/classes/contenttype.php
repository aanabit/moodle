...
abstract class contenttype {
    ...
    public function __construct(\context $context = null) {
        ...
        if ($classname === self::class) {
            throw new coding_exception(get_string('contentbanktypenotfound', 'error', $classname));
        }
        if (empty($context)) {
     ...
     *
     * @param stdClass $content  Th content to be displayed.
     ...
     * @throws coding_exception
     */
    final function can_upload(): bool {
        ...
        return has_capability('moodle/contentbank:upload', $this->context) &&
     ...
     */
    public function is_upload_allowed(): bool {
        // Plugins can overwrite this function to add any check they need.
        return true;
    }
     ...
     * @return array
     */
    abstract public function get_implemented_features(): array;
