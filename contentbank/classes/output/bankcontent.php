...
/**
 * Class containing data for contentbank folder
 *
 * @copyright  2020 Ferran Recio <ferran@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class bankcontent implements renderable, templatable {
    ...
    /**
     * @var \core_contentbank\base[]    Array of folder contents.
     */
    private $contents;
     ...
     * @param array $actions     Array of menu actions.
     */
    public function __construct(int $parentid, array $folders, array $contents, array $toolbar, array $actions) {
        global $DB;
